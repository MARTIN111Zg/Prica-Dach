...
},{"gsap":"node_modules/gsap/index.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"js/adIndicators.js":[function(require,module,exports) {
var define;
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
},{"scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"js/headeranimation.js":[function(require,module,exports) {
...
TweenMax.staggerFrom(".icons li", 2, {
  delay: 2.8,
  opacity: 0,
  y: 40,
  ease: Expo.easeInOut
}, 0.2);
},{}],"js/aboutAnimations.js":[function(require,module,exports) {
"use strict";
...
var trig = document.querySelectorAll(".project");
trig.forEach(function (section) {
  var over = section.querySelector(".overlay__img");
  var info = section.querySelector(".project__info");
  var title = section.querySelector(".small__title");
  var pLink = section.querySelector(".project__link");
  var animateIn = new TimelineMax();
  animateIn.fromTo(over, 1.5, {
    skewX: 30,
    scale: 2
  }, {
    skewX: 0,
...
},{"scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"js/navhandler.js":[function(require,module,exports) {
var navigation = function navigation() {
  var btn = document.querySelector(".nav__btn");
  var overlay = document.querySelector(".overlay__wrapper");
  var links = document.querySelectorAll(".overlay__link__li");
  btn.addEventListener("click", function () {
    overlay.classList.toggle("active");
    btn.classList.toggle("toogle");
    links.forEach(function (link, index) {
      link.style.animation = "movelink 1s ease  ".concat(index / 5, "s");
    });
  });
};

navigation();
},{}],"js/linker.js":[function(require,module,exports) {
var btn = document.querySelector(".nav__btn");
var overlay = document.querySelector(".overlay__wrapper");
var start = document.querySelector(".start");
var uber = document.querySelector(".uber");
...
require("./adIndicators");

require("./headeranimation");

require("./aboutAnimations");
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"../sass/main.scss":"sass/main.scss","gsap/TweenMax":"node_modules/gsap/TweenMax.js","./animation":"js/animation.js","./adIndicators":"js/adIndicators.js","./headeranimation":"js/headeranimation.js","./aboutAnimations":"js/aboutAnimations.js","./navhandler":"js/navhandler.js","./linker":"js/linker.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
